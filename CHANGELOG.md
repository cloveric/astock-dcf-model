...
- **configs/601138.yaml**: 工业富联配置持久化(fetch 自动生成, 含 2026Q1 锚定), 满足"验证记录行可从仓库复现"口径, 回归首页表(DCF 55.2158/FCFE 45.5719, 现价 66.10, ALL PASS)。
...
### 验证
- 五配置(300476/002463/00981/688825/601138)构建+LO 重算+结构化验收全 PASS; 300476 黄金值命中; pytest 92/92。
## [0.6.0] - 2026-08-18
