...
输出：基准 DCF 每股价值 **340.42 元**，Checks 11/11 通过。
...
| 标的 | 模式 | 结果 |
|---|---|---|
| **胜宏科技 (300476)** | 完整手工配置 | 基准 DCF **340.4152 元**；BS 配平差额全期 = 0.00；FIN 迭代残差 ≤ 1.6e-6；CF 期末现金与 BS 货币资金差异 ≤ 1e-12；WACC 实算 7.5620%（βu 中位 1.0108）；Checks **11/11 通过** |
