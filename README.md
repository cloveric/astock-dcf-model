...
| 长鑫科技 688825 | 兜底(零配置,上市第 21 天次新股) | 1.2524 元⁴ | 1.3378 元(+6.8%) | 全期 = 0.00 | ≤ 3.3e-6 | **11/11 门控 TRUE** |
...
⁴ 拐点标的展示项:2025 年报仅微利(18.7 亿)而 2026Q1 单季营收 508 亿/归母 247.6 亿(DRAM 涨价周期),0.5.0 的中报锚定使 2026E 预测校准至年化口径(营收 2,032 亿,锚定精度 99.99%,Checks 信息行可见);后续年增速绝对封顶(25%/15%/10%/8%)、毛利率滑向周期中枢、Capex 按上年绝对额缓降。模型值仍远低于市价(4.13 万亿总市值),主因少数股东权益 973 亿账面扣减、周期顶利润按中枢回落的保守假设与战略溢价——机械 DCF 回答"这些假设值多少钱",不背书市价。

⁴ 工程验收展示行:2026-07-27 上市的科创板次新股,历史两年亏损(−163.4/−71.4 亿)2025 年转盈(+18.7 亿),零配置直建全链路通过——覆盖"亏损历史+IPO 新股"路径。该标的总市值 4.13 万亿元、市场隐含 2026E PE 约 900 倍,属强战略溢价定价,与保守机械 DCF(隐含 2026E PE 18.3x)存在数量级差距,口径之别同 00981 注记,勿作投资参考。
